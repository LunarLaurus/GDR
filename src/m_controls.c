...
// Goblin Dice Rollaz: Crouch/slide key (default: 'c')
int key_crouch = 'c';
...
int key_menu_qsave2   = KEY_PGUP;
int key_menu_endgame   = KEY_F7;
int key_menu_messages  = KEY_F8;
int key_menu_qload     = KEY_F9;
int key_menu_qload2    = KEY_PGDN;
int key_menu_quit      = KEY_F10;
int key_menu_gamma     = KEY_F11;
int key_menu_hud      = KEY_F12;
...
void M_BindBaseControls(void)
{
    ...
    M_BindIntVariable("key_crouch",        &key_crouch);
...
void M_BindMenuControls(void)
{
    ...
    M_BindIntVariable("key_menu_qsave2",    &key_menu_qsave2);
    ...
    M_BindIntVariable("key_menu_qload2",    &key_menu_qload2);
    M_BindIntVariable("key_menu_quit",      &key_menu_quit);
    M_BindIntVariable("key_menu_gamma",     &key_menu_gamma);
    M_BindIntVariable("key_menu_hud",       &key_menu_hud);
