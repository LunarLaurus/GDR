...
static int frame_total_time_ms = 0;
static int frame_tic_time_ms = 0;
static int frame_render_time_ms = 0;
static int frame_display_time_ms = 0;
...
void D_BindVariables(void)
{
    ...
    M_BindIntVariable("dice_crosshair_type", &dice_crosshair_type);
    M_BindIntVariable("dice_crosshair_color", &dice_crosshair_color);
    M_BindIntVariable("dice_crosshair_scale", &dice_crosshair_scale);
    ...
    for (i=0; i<10; ++i)
    {
        ...
        chat_macros[i] = (char *)chat_macro_defaults[i];
